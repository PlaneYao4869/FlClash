...
## PlaneClash
本人在flclash开源代码基础上进行了二创（致歉，若有侵权请致信至planeyao4869@gmail.com），加入了白名单辅助功能（其实就是把原本有的规则功能的一部分提取出来换个实现方式）
...
A multi-platform proxy client based on ClashMeta, simple and easy to use, open-source and ad-free. Includes whitelist management feature for selective proxy routing.
