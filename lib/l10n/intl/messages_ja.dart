...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addWhitelist": MessageLookupByLibrary.simpleMessage("ホワイトリストを追加"),
    "editWhitelist": MessageLookupByLibrary.simpleMessage("ホワイトリストを編集"),
    "domain": MessageLookupByLibrary.simpleMessage("ドメイン"),
    "descriptionOptional": MessageLookupByLibrary.simpleMessage("説明（任意）"),
    "importCommonWebsites": MessageLookupByLibrary.simpleMessage("一般的なWebサイトをインポート"),
    "noWhitelistDomains": MessageLookupByLibrary.simpleMessage("ホワイトリストドメインがありません"),
    "yearsAgo": m19,
